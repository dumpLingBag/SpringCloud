...
public interface SocketService {
     ...
     * @Date 2019/4/30
     **/
    @RequestMapping(value = "/socket/getCacheMessage", method = RequestMethod.GET)
    Result<?> getCacheMessage(@RequestParam("sendUserId") String sendUserId, @RequestParam("receiveUserId") String receiveUserId);
