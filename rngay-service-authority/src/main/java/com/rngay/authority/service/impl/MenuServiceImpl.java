...
public class MenuServiceImpl extends ServiceImpl<MenuDao, MenuDTO> implements MenuService {
    ...
    @Override
    public List<MenuDTO> listMenuByOrgId(Long orgId, Integer filed) {
    ...
    @Override
    public List<MenuDTO> listMenuByUserId(Long orgId, Long userId, Integer filed) {
        ...
        if (orgId != null && orgId > 0) {
            ...
            return menuDao.listMenuByOrgUserId(orgRoles, roleIds, filed);
        }
        return menuDao.listMenuByUserId(roleIds, filed);
    }
    ...
    private void children(MenuDTO mu,MenuDTO menu) {
        MenuUtil.menuDto(mu, menu, Constant.MENU_TYPE_NOT_VO);
