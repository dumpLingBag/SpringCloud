...
public interface PFUserService {
    ...
    Result<UaUserDTO> getUserById(@PathVariable(value = "id") Long id);
    ...
    Result<String> reset(@PathVariable(value = "id") Long id);
    ...
    Result<Integer> enabled(@PathVariable(value = "id") Long id, @PathVariable(value = "enabled") Integer enabled);
